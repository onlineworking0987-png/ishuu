...
export default function ContactPage() {
  ...
  const getMissingRequiredFields = () => {
    ...
    if (!formData.numberOfEmployees.trim()) missing.push("No. of employees");
    if (!formData.location.trim()) missing.push("Location");
    if (!formData.phoneNumber.trim()) missing.push("Telephone");
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok || !data || data.ok !== true) {
        toast.error(data && "error" in data && data.error ? data.error : "Could not send message.");
        return;
      }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-sans font-bold text-brand-red mb-3">
              Get in touch
            </h1>
