  ...
  return (
    <footer ref={ref} className="relative pt-14 pb-0 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Main grid */}
        <div
          className={`grid grid-cols-1 md:grid-cols-[1.2fr_1fr_1.4fr] gap-10 lg:gap-16 pb-12 border-b border-white/15 transition-all duration-1000 ${
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-[260px]">
              Your digital operations, entirely off your plate. We build,
              maintain, and improve so you can focus on growth.
            </p>
          </div>
        ...
        {/* Bottom bar */}
        <div
          className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 py-5 transition-all duration-1000 delay-200 ${
      ...
      <div
        className={`mt-1 flex w-full min-w-0 justify-center overflow-x-clip px-4 sm:px-8 md:px-12 transition-all duration-1000 delay-400 ${
