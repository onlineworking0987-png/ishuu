    ...
    <section className="relative py-16 lg:py-20 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            <span className="font-serif italic text-foreground">Everything you worry about</span>{" "}
            <span className="font-sans font-bold text-brand-red">is covered here.</span>
          </h2>
        </div>
        ...
        <div ref={gridRef} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {scopes.map((scope, index) => (
            <div
              key={index}
              className={`group relative rounded-3xl p-8 text-center transition-all duration-700 hover-lift ${
            ...
            >
              ...
              <div 
                className={`absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
                  scope.color === 'brand-pink' ? 'bg-gradient-to-br from-brand-pink/5 to-transparent' : 'bg-gradient-to-br from-brand-red/5 to-transparent'
                }`} 
              />
              ...
              <div className="relative">
                <div 
                  className={`w-18 h-18 w-[72px] h-[72px] rounded-2xl flex items-center justify-center mx-auto mb-6 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 ${
                    scope.color === 'brand-pink' 
