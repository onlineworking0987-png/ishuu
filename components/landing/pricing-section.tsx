...
const plans = [
  {
    ...
    period: "/ month",
    description:
      "Ongoing system stability and maintenance. The foundation that keeps everything running.",
    features: [
...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="relative py-16 lg:py-20 bg-white overflow-hidden noise">
      {/* Background elements */}
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-12">
          <h2 
            className={`text-3xl md:text-4xl lg:text-5xl mb-3 text-balance transition-all duration-700 ${
          ...
          <p 
            className={`text-xl text-muted-foreground font-serif italic transition-all duration-700 delay-100 ${
              headerInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="relative flex flex-col flex-1">
                ...
                <ul className="space-y-4 mb-8 flex-1">
                  {plan.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start gap-3">
                      <div
                        className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 transition-transform duration-300 group-hover:scale-110 ${
                          plan.highlighted ? "bg-white/20" : "bg-brand-red/10"
                        }`}
                      >
                        <Check
                          size={14}
                ...
                <Button
                  asChild
                  className={`w-full rounded-full py-6 text-base font-medium btn-ripple group/btn ${
                    plan.highlighted
